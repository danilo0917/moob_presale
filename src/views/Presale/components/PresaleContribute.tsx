  ...
  return (
    ...
    <Row>
      ...
      {!account && <UnlockButton fullWidth />}
        ...
        <LabelButton
          ...
          buttonLabel='Claim'
          label='Your tokens to claim (MOOB)'
          value={
            // eslint-disable-next-line no-nested-ternary
            isFinished
              ? claimed
    ...
    <Row>
      ...
      <StyledPreSaleCard>
        ...
        <RowItem>
          <Text fontSize='18px' mr='16px'>- MOOB Presale Price: </Text>
          <CardValue fontSize='18px' value={10} decimals={2} prefix='$'/>
        </RowItem>
        <RowItem>
          <Text fontSize='18px' mr='16px'>- MOOB Launch Price: </Text>
        ...
        <RowItem>
          <Text fontSize='18px' mr='16px'>- Minimum Contribution - 500 BUSD</Text>
        </RowItem>
        <RowItem>
          <Text fontSize='18px' mr='16px'>- Maximum Contribution - 2000 BUSD</Text>
        </RowItem>
      </StyledPreSaleCard>
    </Row>
    </>
